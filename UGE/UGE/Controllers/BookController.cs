...
namespace UGE.Controllers
{
    public class BookController : Controller
    {
        ...
        public ActionResult Create([Bind(Include="BookID,SubjectID,BookName")] Book book)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include="BookID,SubjectID,BookName")] Book book)
        {
            if (ModelState.IsValid)
            {
